...
- Interface
  ...
  之后新建的 Java Interface 文件会自动填充携带有 `@author` 和 `@since` 的 Java Doc 注释：![new-java-class-with-java-doc](https://rmt.ladydaily.com/fetch/seven/storage/image-20210726021142323.png)
